...
if TYPE_CHECKING:
    from app.domains.auth.models import Denizen, House
...
class OwnedBuilding(Base):
    ...
    owner_denizen_id: Mapped[int] = mapped_column(ForeignKey("denizens.id"), index=True)
    ...
    owner: Mapped["Denizen"] = relationship(back_populates="owned_buildings")
